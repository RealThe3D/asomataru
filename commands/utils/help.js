    ...
    if (!args[0]) {
      ...
      if (client.commands.has(command) || client.aliases.has(command)) {
        ...
        const embed = new MessageEmbed()
          ...
          .addField(
            client.i18n.get(message.guild.language, "commands", "help_name"),
            command.name
          )
          .addField(
            client.i18n.get(
            ...
            command.permissions[0]
              ...
              : client.i18n.get(message.guild.language, "commands", "not_found")
          )
          .addField(
            client.i18n.get(message.guild.language, "commands", "help_aliases"),
            command.aliases[0]
