...
module.exports = {
  ...
  exec: async (client, message, args) => {
    ...
    if (!args[0]) {
      ...
      if (command.permissions) helpEmbed.addField("**Required Permission(s):**", command.reqPermissions.join(', '));
      if (command.ownerOnly) helpEmbed.addField("**Dev**", "Only bot owner can execute this command.");
